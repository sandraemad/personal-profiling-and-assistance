...
@Component({
  ...
  imports: [HeaderComponent,RouterLink,GoogleMapsModule,NgIf],
...
toggleResult(): void {
  ...
  if (this.cnt >= 0 && this.cnt <= 4) this.result = "الاكتئاب بسيط";
  else if (this.cnt >= 5 && this.cnt <= 9) this.result = "الاكتئاب متوسط";
  else if (this.cnt >= 10 && this.cnt <= 14) this.result = "الاكتئاب متوسط إلى شديد";
  else if (this.cnt >= 15 && this.cnt <= 21) this.result = "الاكتئاب شديد";
